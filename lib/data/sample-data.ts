...
const ROWS: Row[] = [
  ["Ligne 18 — Viaduc T2A", "Société du Grand Paris", "Ouvrages d'art", 0, 4, 62, "à risque", 4200, "2025-03-01", "2026-09-30", "DCE — Lot T2A", "2026-06-18"],
  ...
  ["Tunnel de Belledonne", "SNCF Réseau", "Tunnels / Géotechnique", 3, 5, 88, "à jour", 7600, "2024-09-01", "2026-10-05", "Plans d'exécution — visa", "2026-06-16"],
  ["Quartier Rive-Étoile", "Métropole de Lyon", "Bâtiment / VRD", 4, 1, 28, "à risque", 3100, "2026-01-10", "2026-09-10", "Rapport APS", "2026-06-20"],
  ["Pont de l'Estuaire — Inspection", "CD44", "Ouvrages d'art", 1, 3, 46, "en retard", 90, "2025-09-01", "2026-06-08", "Rapport diagnostic", "2026-05-28"],
  ...
  ["Station épuration Garonne", "Bordeaux Métropole", "Hydraulique", 2, 1, 22, "à risque", 4600, "2026-02-01", "2026-10-30", "Rapport APS", "2026-06-24"],
  ["Tramway T9 — Extension", "Île-de-France Mobilités", "Mobilités", 1, 3, 58, "à jour", 8200, "2025-04-01", "2026-11-15", "Dossier PRO", "2026-07-06"],
  ["Barrage de Serre — Réfection", "EDF", "Hydraulique / Géotech.", 3, 5, 76, "à risque", 5900, "2024-12-01", "2026-09-25", "Visa note de calcul EXE", "2026-06-23"],
  ...
  ["Usine hydroélectrique Drac", "EDF", "Énergie / Hydraulique", 5, 3, 46, "en retard", 8800, "2025-02-01", "2026-06-05", "Dossier PRO", "2026-05-20"],
...
function buildSubtasks(row: Row, idx: number): Subtask[] {
  const [, , discipline, lead, phaseIndex, progress, status, , start, deadline, renduLabel, renduDate] = row;
  ...
  const defs: { name: string; assigneeId: number; start: string; plannedDays: number }[] = [
    { name: pool[0], assigneeId: lead, start: t1Start, plannedDays: d[0] },
    { name: pool[1], assigneeId: m(1), start: t2Start, plannedDays: d[1] },
    { name: renduLabel, assigneeId: lead, start: t3Start, plannedDays: d[2] },
    { name: pool[2], assigneeId: m(2), start: t4Start, plannedDays: d[3] },
    { name: closeout, assigneeId: m(4), start: t5Start, plannedDays: d[4] },
